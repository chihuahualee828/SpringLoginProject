...
var stompClientDisconnected=true;

function connect() {
    if(username && stompClientDisconnected) {
        //usernamePage.classList.add('hidden');
        //chatPage.classList.remove('hidden');
		stompClientDisconnected=false;
        var socket = new SockJS('/demo1/chatroom');
...
function onConnected() {
    ...
    stompClient.send("/app/join",
        {},
        JSON.stringify({senderName: username, status: 'JOIN'})
    )
